export function buildSystemPrompt(knowledgeBase: string): string {
  return [
    ...
    '3. ทุกครั้งที่อ้างอิง ให้ระบุชื่อเอกสารต้นทางคู่กับเลขข้อ/มาตรา/หมวดเสมอ เนื่องจากมี 2 เอกสารที่เลขข้อซ้ำกันได้ (เช่น "ตามระเบียบฌาปนกิจสงเคราะห์ฯ ข้อ 12 วรรคสอง" หรือ "ตามข้อบังคับสมาคมฯ ข้อที่ 12")',
