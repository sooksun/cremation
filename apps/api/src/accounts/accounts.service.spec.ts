...
describe('AccountsService.closeAccountingYear', () => {
  ...
  /**
   * ข้อบกพร่องที่เจอระหว่างเขียนเทสต์:
   * closeAccountingYear ปิดเฉพาะบัญชีที่ยอด > 0 (`if (acc && inc.amount > 0)`)
   ...
   */
  it.failing('บัญชีรายได้ที่ยอดติดลบต้องถูกล้างด้วย ไม่งั้น 399 เหลือยอดค้างข้ามปี', async () => {
